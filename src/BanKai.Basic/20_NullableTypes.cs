...
namespace BanKai.Basic
{
    ...
    public class NullableTypes
    {
        ...
        {
            // nullable type value range: underlying value type + assigned null
        ...
        public void should_returns_false_if_one_of_the_nullable_instance_has_no_value_when_doing_operator_lifting()
        {
            ...
            // assigned null compare with value type value always produce false
            ...
            // Assert.Equal(expectedResultForNullIsLargerThanNull, (int?) null == (int?) null); true
        }
